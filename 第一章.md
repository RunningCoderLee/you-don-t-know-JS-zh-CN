...
JavaScript提供了几种不同的强制转化类型的方法，例如：
```js
var a = "42";
var b = Number( a );
...
To help you out in these common situations, JavaScript will sometimes kick in and *implicitly* coerce values to the matching types.这种情况比较常见，JavaScript有时会使用隐式转换后的值来进行比较。
